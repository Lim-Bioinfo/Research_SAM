...
def find_optimal_neighbors_resolution(
    ...
    for n_nb in tqdm(range(neighbor_range[0], neighbor_range[1]+1, neighbor_step),
        ...
        for res in res_values:
            sc.tl.leiden(adata, resolution=res, flavor='igraph', key_added='leiden_temp')
...
best_combo, best_sil = find_optimal_neighbors_resolution(
    adata,
    pcs=pcs,
    neighbor_range=(2, 21), # 2, 21
    resolution_range=(2, 29), # 0.3, 50.1
    neighbor_step=1,
    resolution_step=0.1
)
...
color_dict = palette={'0': "#009193", '1': "#941751", '2': "#FF8AD8", '3': "#005493", '4': "#7A81FF", '5': "#76D6FF", '6': "#FF7E79", '7': "#FF2600", 
                     '8': "#0096FF", }
sc.pl.umap(adata, color=["leiden"], palette=color_dict, title="Leiden Clusters (res=0.5)", size = 100, save="GSE81383_clustered.svg")
...
color_dict = palette={"B1 B": "#005493", "CD16+ Mono": "#76D6FF", "Erythroblast": "#FF2600", "G/M prog": "#941751",
                     "Lymph prog": "#7A81FF", "NK": "#009193", "pDC": "#0096FF"}
sc.pl.umap(adata, color="annotated_celltype", palette= color_dict , size = 100, save="GSE81383_annotated.svg")

# Save annotated with group information figure
color_dict = palette={"Group1": "#941751", "Group2": "#7A81FF", "Group3": "#009193"}
sc.pl.umap(adata, color="Group", palette=color_dict, title="Predicted samples in GSE81383", size = 100, save="GSE81383_grouped.svg")

# Save annotated with predicted tumor sample information figure
sc.pl.umap(adata, color="Predicted", palette={"Primary": "#0070C0", "Metastases": "#C00000"},  title="Predicted samples in GSE81383", size = 100, save="GSE81383_predicted.svg")
